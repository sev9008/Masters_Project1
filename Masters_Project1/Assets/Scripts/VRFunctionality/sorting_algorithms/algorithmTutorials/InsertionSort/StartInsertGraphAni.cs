...
public class StartInsertGraphAni : MonoBehaviour, IPointerDownHandler
{
    public InsertionSortAni thirdDselectionani;
    ...
    {
        yield return sho = StartCoroutine(thirdDselectionani.Insertion(arr1, size));
        running = false;
    }
}
