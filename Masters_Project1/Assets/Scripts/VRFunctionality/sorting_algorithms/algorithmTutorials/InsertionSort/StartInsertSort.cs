...
public class StartInsertSort : MonoBehaviour, IPointerDownHandler
{
    ...
    public void OnPointerDown(PointerEventData eventData)
    {
        ...
        m_insertSort_ArrayHolder.Display(arr2, size, -1, -1);
    ...
    public IEnumerator startani()
    {
        ...
        yield return sho = StartCoroutine(m_insertSort_ArrayHolder.Insertion());
