...
public class StartQuickSortAni : MonoBehaviour, IPointerDownHandler
{
    public QuickSortAni thirdDselectionani;
    ...
    {
        yield return sho = StartCoroutine(thirdDselectionani.Quick(arr1));
        running = false;
    }
}