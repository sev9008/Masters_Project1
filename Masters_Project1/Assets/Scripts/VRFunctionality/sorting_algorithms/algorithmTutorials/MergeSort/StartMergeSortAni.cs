...
public class StartMergeSortAni : MonoBehaviour, IPointerDownHandler
{
    public MergeSortAni thirdDselectionani;
    ...
    {
        yield return sho = StartCoroutine(thirdDselectionani.IEMerge(arr1));
        running = false;
    }
}