...
public class ProcScopeController : MonoBehaviour
{
    ...
    public IEnumerator ScopeRun()
    {
        while (begin)//repeat the routine as long as begin is true
        {
            ...
            for (int i = 0; i < Panels.Count; i++)//run through every panel
            {
                ...
                if (i == 1)//enable or disable the first output
                {
                ...
                if (i == 2)//enable or disable the first output
                {
                    Output[3].SetActive(true);
                }
                else
                {
                    Output[3].SetActive(false);
                }

                if (i == 3)//enable or disable the first output
                {
                    Output[4].SetActive(true);
                }
                else
                {
                    Output[4].SetActive(false);
                }

                if (i == 4)//enable or disable the first output
                {
                    Output[5].SetActive(true);
                }
                else
                {
                    Output[5].SetActive(false);
                }

                if (i == 6)//enable or disable the first output
                {
                    Output[7].SetActive(true);
                }
                else
                {
                    Output[7].SetActive(false);
                }

                if (i == 7)//enable or disable the first output
                {
                ...
                {
                    Output[8].SetActive(true);
                }
                else
                {
                    Output[8].SetActive(false);
                }

                if (i == 10)//enable or disable the first output
                {
                    Output[6].SetActive(true);
                }
                else
                {
                    Output[6].SetActive(false);
                }
